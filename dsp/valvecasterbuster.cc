// generated from file './/valvecasterbuster.dsp' by dsp2cc:
// Code generated with Faust 0.9.90 (http://faust.grame.fr)


namespace valvecasterbuster {
...
Dsp::Dsp()
	...
	id = "valvecasterbuster";
	name = N_("valvecasterbuster");
...
} // end namespace valvecasterbuster
